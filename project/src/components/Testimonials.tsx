...
//   return (
//     <section className="py-20 bg-gradient-to-b from-blue-50 to-white px-6 sm:px-8 lg:px-12 border border-gray-300 rounded-none">
...
//             <div key={index} className="bg-white border-2 border-gray-200 rounded-none p-8 hover:border-blue-300 transition-colors duration-300">
//               <div className="flex items-center mb-6">
//                 <img
//                   src={testimonial.image}
//                   alt={testimonial.name}
//                   className="w-16 h-16 rounded-none object-cover mr-4 border border-gray-300"
//                 />
//                 <div>
