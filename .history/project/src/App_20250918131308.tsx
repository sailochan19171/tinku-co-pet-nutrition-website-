...
function Home() {
  ...
  return (
    // Clean white background like reference site
    <div className="min-h-screen bg-white">
      <Header />
      <main className="space-y-0">
        {/* Hero Section - Large background image/video with overlay text */}
        <Hero />

        {/* Product Showcase - Similar to reference site's product collection */}
        <SingleProduct />

        {/* Featured Benefits - Similar to reference site's collection highlights */}
        <WhyChoose />

        {/* New/Featured Section - Similar to reference site's new arrivals */}
        <HealthBenefits />

        {/* How It Works - Similar to reference site's meet the essentials */}
        <HowItWorks />

        {/* Newsletter Section - Similar to reference site's newsletter */}
        <Newsletter />
