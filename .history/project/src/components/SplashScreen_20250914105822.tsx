    ...
    <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-white">
      <div className="flex flex-col items-center">
        <img
          src={logoSrc}
          alt="Loading"
          className="w-40 h-40 md:w-52 md:h-52 md:w-52 md:h-52 animate-[splash-bounce_1.2s_ease-in-out_infinite]"
        />
        <div className="mt-4 text-sm text-gray-500">Loading...</div>
      </div>
      {/* Custom Custom keyframes for a subtle pulsefor a subtle pulse */}
      <style>
        {`
