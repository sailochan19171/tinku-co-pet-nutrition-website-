      ...
      <div className="max-w-7xl mx-auto py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            {/* Simple email subscribe input (no button) */}
            <label htmlFor="footer-email" className="sr-only">Subscribe for updates</label>
            <input
              id="footer-email"
              type="email"
              placeholder="Enter your email to subscribe"
              className="w-full max-w-xs p-3 mb-4 bg-gray-800/60 text-white placeholder-gray-400 border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
