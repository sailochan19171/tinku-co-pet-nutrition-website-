...
import { PawPrint, Home, Baby, Dog, ArrowRight } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-6">
          {cases.map((c) => (
            <div key={c.title} className="bg-white/85 backdrop-blur-sm rounded-2xl shadow-lg p-6 ring-1 ring-blue-200/50 h-full flex flex-col">
              ...
              <a href={c.href} className="mt-4 inline-flex items-center gap-1 text-blue-700 hover:text-blue-800 font-semibold text-sm">
