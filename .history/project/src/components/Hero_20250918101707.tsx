...
const Hero: React.FC<HeroProps> = ({ onStartQuiz }) => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-[#dff0fb] via-[#eaf6ff] to-[#c8e3f6] px-6 sm:px-8 lg:px-12 pt-20 sm:pt-24 pb-20 sm:pb-28" data-aos="fade-up">
      <div className="relative z-10 max-w-7xl mx-auto" data-aos="fade-up" data-aos-delay="100">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-8" data-aos="fade-up" data-aos-delay="200">
          ...
          <div className="order-2 lg:order-1 w-full lg:w-auto flex justify-center lg:justify-start" data-aos="zoom-in" data-aos-delay="250">
          ...
          {/* Text content */}
          <div className="order-1 lg:order-2 lg:max-w-3xl" data-aos="fade-left" data-aos-delay="300">
            ...
            <div className="mt-10 flex sm:justify-start justify-center" data-aos="fade-up" data-aos-delay="400">
              <a
                href="#product"
                className="bg-blue-700 hover:bg-blue-800 text-white font-bold py-4 px-8 rounded-lg text-xl sm:text-2xl transition-colors duration-200"
              >
                View Product
              </a>
            </div>
