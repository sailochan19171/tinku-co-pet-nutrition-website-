...
const AboutUs: React.FC = () => {
  return (
    <section id="about" className="py-20 bg-gradient-to-b from-white to-blue-50 px-6 sm:px-8 lg:px-12 border border-gray-300 rounded-none">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-16">
          <div>
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                Founded in 1968 by Dr. Mark Tinku, a veterinary nutritionist with a passion for
                improving pet health through better nutrition. What started as a small research
                facility has grown into a global leader in pet nutrition science.
              </p>
              <p>
                Our journey began with a simple observation: pets fed scientifically formulated
                diets lived longer, healthier lives. This insight drove us to invest heavily in
                research and development, working closely with veterinarians and pet nutritionists.
              </p>
              <p>
                Today, Tinku & Co. products are trusted by millions of pet parents worldwide,
                recommended by veterinarians, and backed by over 200 scientific studies.
              </p>
            </div>
          </div>
          <div>
