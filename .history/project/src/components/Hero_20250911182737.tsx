...
const Hero: React.FC = () => {
  return (
    <section className="relative bg-gradient-to-r from-blue-50 to-blue-100 overflow-hidden pt-24 sm:pt-28 px-4 sm:px-6 lg:px-8 border border-gray-300 rounded-none">
