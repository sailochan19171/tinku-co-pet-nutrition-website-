    ...
    <div className="relative">
      ...
      {!consented && (
        <div className="fixed inset-0 z-[1100] flex items-center justify-center bg-white/50 backdrop-blur-sm">
          ...
          {/* Consent card */}
                              <div className="relative z-[1110] fixed inset-0 z-[1100] flex items-center justify-center bg-white/50 backdrop-blur-sm">
          {/* Big animated logo behind the consent card */}
          <div className="absolute inset-0 flex items-center justify-center">
                <img
              src="/tinku-logo.png"
                  alt="Loading"
                  cla    ssName="w-44 h-44 md:w-56 md:h-56 opacity-90 animate-[splash-bounce_1.2s_ease-in-out_infinite]"
                /    >
              </div>
            ...
            <p className="mt-2 text-sm text-gray-600">
              We use cookies to enhance your experience and analyze traffic. Please accept cookies to continue using the sKeep blurred/overlay if denied
    >  p>
