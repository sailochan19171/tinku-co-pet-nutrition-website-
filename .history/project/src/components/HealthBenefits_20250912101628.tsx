...
const HealthBenefits: React.FC = () => {
  ...
  return (
    <section id="health" className="relative overflow-hidden py-20 bg-gradient-to-b from-white to-blue-50">
      {/* Centered decorative paw background */}
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        <svg
          ...
          aria-hidden="true"
        >
          {/* Simple paw print composed of pads */}
          <ellipse cx="100" cy="120" rx="40" ry="30" fill="#1e40af" />
          <circle cx="65" cy="70" r="12" fill="#1e40af" />
          <circle cx="95" cy="55" r="12" fill="#1e40af" />
          <circle cx="125" cy="70" r="12" fill="#1e40af" />
          <circle cx="85" cy="85" r="12" fill="#1e40af" />
        </svg>
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <button className="mt-8 bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-lg text-lg transition-colors duration-200">
