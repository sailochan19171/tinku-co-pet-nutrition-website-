    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex gap-8">
            <a href="#products" className="text-gray-700 hover:text-blue-600 font-medium border-b-2 border-transparent hover:border-blue-600 pb-1 transition-colors duration-200">Products</a>
            ...
            <a href="#benefits" className="text-gray-700 hover:text-blue-600 font-medium border-b-2 border-transparent hover:border-blue-600 pb-1 transition-colors duration-200">Benefits</a>
            <a href="#cleaning-power" className="text-gray-700 hover:text-blue-600 font-medium border-b-2 border-transparent hover:border-blue-600 pb-1 transition-colors duration-200">Cleaning Power</a>
            <a href="#testimonials" className="text-gray-700 hover:text-blue-600 font-medium border-b-2 border-transparent hover:border-blue-600 pb-1 transition-colors duration-200">Testimonials</a>
      ...
      >
        <nav className="px-4 py-3 flex flex-col gap-3">
          ...
          <a href="#cleaning-power" className="text-gray-700 hover:text-blue-600">Cleaning Power</a>
