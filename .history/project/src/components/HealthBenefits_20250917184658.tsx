...
const HealthBenefits: React.FC = () => {
  ...
  const benefits = [
    {
      icon: Shield,
      title: 'Pet-Safe Formula',
      description: 'Non-toxic, dye-free, and ammonia-free. Safe for paws and pet areas when used as directed.',
      color: 'bg-green-500',
    },
    {
      icon: Zap,
      title: 'Powerful Cleaning',
      description: 'Lifts dirt, mud, and messes fast without leaving sticky residue or dulling floors.',
      color: 'bg-yellow-500',
    },
    {
      icon: Heart,
      title: 'Odor Neutralization',
      description: 'Enzymatic action targets urine and organic odors at the source for lasting freshness.',
      color: 'bg-red-500',
    },
    {
      icon: Brain,
      title: 'Gentle Chemistry',
      description: 'Neutral pH and low VOCs help protect sensitive noses—no harsh fumes.',
      color: 'bg-purple-500',
    },
    {
      icon: Bone,
      title: 'Multi-Surface Safe',
      description: 'Suitable for sealed hardwood, tile, laminate, and vinyl. Always test on a small area first.',
      color: 'bg-blue-500',
    },
    {
      icon: Eye,
      title: 'Residue-Free Shine',
      description: 'Dries quickly with a streak-free finish to keep floors looking their best.',
      color: 'bg-orange-500',
    },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative text-center mb-16">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Tough on stains and odors, safe for paws and everyday family life. Designed for pet homes.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h4 className="text-4xl font-bold text-blue-600 mb-6">Pro Results</h4>
              <h5 className="text-2xl font-semibold text-gray-800 mb-6">for Pet Homes</h5>
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-blue-600 rounded-full mr-4"></div>
                  <span className="text-gray-700">Suitable for multiple floor types</span>
                </div>
              </div>
              <a href="#how-it-works" className="inline-block mt-8 bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-lg text-lg transition-colors duration-200">
                See How It Works
              </a>
            </div>
