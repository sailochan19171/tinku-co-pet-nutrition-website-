    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex gap-8">
            <a href="#buy" className="text-blue-700 font-semibold border-b-2 border-blue-600 pb-1">Buy</a>
            ...
            <a href="#health" className="text-gray-700 hover:text-blue-600 font-medium border-b-2 border-transparent hover:border-blue-600 pb-1 transition-colors duration-200">Benefits</a>
      ...
      >
        <nav className="px-4 py-3 flex flex-col gap-3">
          <a href="#buy" className="text-blue-700">Buy</a>
