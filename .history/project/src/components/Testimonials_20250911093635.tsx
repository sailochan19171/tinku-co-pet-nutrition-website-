      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h3 className="text-4xl lg:text-5xl font-bold text-blue-600 mb-8">
            Pet Parents & Professionals
          </h3>
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Join thousands of satisfied customers who have seen remarkable improvements 
          ...
          <div className="bg-blue-600 text-white rounded-2xl p-8 inline-block">
            <div className="flex items-center justify-center space-x-8">
              ...
              <div className="text-center">
                ...
                <div className="text-blue-200">Vet Recommendations</div>
              </div>
            </div>
          </div>
        </div>
