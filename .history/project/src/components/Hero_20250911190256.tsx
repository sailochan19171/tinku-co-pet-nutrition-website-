...
const Hero: React.FC<HeroProps> = ({ onStartQuiz }) => {
  return (
    <section className="relative bg-gradient-to-r from-blue-50 to-blue-100 overflow-hidden px-6 sm:px-8 lg:px-12 pt-16 sm:pt-20 border border-gray-300 rounded-none">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              ...
              <div className="mt-8">
                <button
                  onClick={onStartQuiz}
                  className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-none text-lg transition-colors duration-200"
                >
                  Find Your Formula
                </button>
              </div>
      ...
      {/* Hero Image */}
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-5/12 flex items-center justify-center p-4">
        <img
          className="h-48 w-auto object-cover sm:h-64 md:h-80 lg:h-96 rounded-md shadow-md border border-gray-200"
