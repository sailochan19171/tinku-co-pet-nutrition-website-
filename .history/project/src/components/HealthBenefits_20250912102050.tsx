        ...
        <div className="relative text-center mb-16">
          <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
            <svg
              ...
              aria-hidden="true"
            >
              <ellipse cx="100" cy="120" rx="38" ry="28" fill="#1e40af" />
              <circle cx="65" cy="70" r="11" fill="#1e40af" />
              <circle cx="95" cy="55" r="11" fill="#1e40af" />
              <circle cx="125" cy="70" r="11" fill="#1e40af" />
              <circle cx="85" cy="85" r="11" fill="#1e40af" />
            </svg>
          </div>
