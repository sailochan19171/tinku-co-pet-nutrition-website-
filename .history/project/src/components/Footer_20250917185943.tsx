        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Pet-safe floor care for real-life messes. Powerful on stains and odors, gentle on paws.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#products" className="text-gray-400 hover:text-white border-b border-transparent hover:border-gray-400 pb-1 transition-colors duration-200">Daily Floor Cleaner</a></li>
              <li><a href="#products" className="text-gray-400 hover:text-white border-b border-transparent hover:border-gray-400 pb-1 transition-colors duration-200">Enzyme Odor Remover</a></li>
              <li><a href="#products" className="text-gray-400 hover:text-white border-b border-transparent hover:border-gray-400 pb-1 transition-colors duration-200">Multi-Surface Cleaner</a></li>
              <li><a href="#products" className="text-gray-400 hover:text-white border-b border-transparent hover:border-gray-400 pb-1 transition-colors duration-200">Concentrate Refills</a></li>
            </ul>
          </div>
